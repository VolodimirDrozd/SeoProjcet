...
public class SeoApi
{
    ...
    public Call<CategoryResponse> getCategories(int projectId)
    {
    ...
    {
        Retrofit retofit = new Retrofit.Builder().baseUrl(baseUrl).addConverterFactory(JacksonConverterFactory.create(objectMapper))
                .build();
    ...
    public interface API
    {
        ...
        Call<CategoryResponse> getCategories(@Path("categoryId") int categoryId);
    }
